...
public class TournamentsInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (tournamentRepository.findByName("summer").isEmpty()) {
            ...
            tournament.setRegistrationDeadline(ZonedDateTime.of(2025, 6, 20, 23, 59, 0, 0, ZoneId.of("UTC")).toInstant());
            tournamentRepository.save(tournament);
        }
        ...
        if (tournamentRepository.findByName("autumn").isEmpty()) {
            ...
            tournament.setRegistrationDeadline(ZonedDateTime.of(2025, 8, 31, 23, 59, 0, 0, ZoneId.of("UTC")).toInstant());
            tournamentRepository.save(tournament);
        }
        ...
        if (tournamentRepository.findByName("winter").isEmpty()) {
            ...
            tournament.setRegistrationDeadline(ZonedDateTime.of(2025, 12, 20, 23, 59, 0, 0, ZoneId.of("UTC")).toInstant());
            tournamentRepository.save(tournament);
        }
    }
}
